defmodule Tunez.Music.Album do
  ...
  # Q: How does Ash respond to invalid data coming in from the db?
  validations do
    # Annoying we are making up words like `numericality` here.
    validate numericality(:year_released,
               greater_than: 1950,
               # Q: Is this a runtime validation or compile time?
